            ...
            <Collapse in={isOpen}>
                <div id="example-collapse-text" className=''>
                    <div className="d-flex gap-2 justify-content-center m-2">
                        ...
                        <div className='w-50'>
                            <select onChange={(e) => changeSelectDate(e)} name="date" id="" className='border-0 border-bottom rounded p-1 w-100' style={{ height: '5vh', outline: 'none', background: '#dee2e6' }}>
                        ...
                        <div className='w-50'>
                            <select  name="status" id="" className='border-0 border-bottom w-100 rounded p-1' style={{ height: '5vh', outline: 'none', background: '#dee2e6' }}>
