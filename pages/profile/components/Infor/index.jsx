...
const Infor = ({ userDetail }) => {
  ...
  const submitUpdate = async (e) => {
    ...
    console.log('%cInfor.jsx line:54 user', 'color: #007acc;', user);
    ...
    <div className="profile-content-mobile">
      <div className="rounded w-100 bg-white p-3">
        <form onSubmit={submitUpdate}>
              ...
              <h6 className="title-section">
                ...
                <div className="">
                  <div className="input-form-profile">
                    <span> Họ và tên </span>
                    <input required className="inputFomCustom rounded w-75" onChange={(e) => setUser({ ...user, fullName: e.target.value })} value={user['fullName']} type="text" placeholder="Họ và tên" />
                  </div>
                  <div className="input-form-profile">
                   <span>Ngày sinh </span> 
                  ...
                  <div className="input-form-profile">
                    <span>Địa chỉ</span> 
                    <input required className="inputFomCustom rounded w-75" onChange={(e) => setUser({ ...user, address: e.target.value })} value={user['address']} type="text" placeholder="Địa chỉ" />
                  </div>
                </div>
            </div>
            ...
            <div className="">
              <Button  type="submit" variant="outline-primary" className="w-100 rounded">Lưu thay đổi</Button>{' '}
            </div>
        </form>
