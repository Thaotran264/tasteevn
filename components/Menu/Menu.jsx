      ...
      {!isDefault && (
        <div className="container py-2 " id="menu">
          ...
          <div className=" hideOnDesktop row position-relative">
            {/* Mobile menu */}
            <div
              className={` menuRecipe bg-white col-12 col-md-4 py-1 ${
                menuPos == "position-fixed top-0 start-0 end-0" ? menuPos + " gx-5 active" : ""
              }`}
              style={
            ...
            {/*End Mobile menu */}
            <div
              className={`col-12 col-md-8 bg-white py-1 ${
                menuPos == "position-fixed top-0 start-0 end-0" ? "offset-md-4" : ""
              }`}
            >
          ...
          <div className="row hideOnMB ">
            ...
            <div
              className={` bg-white ${
                menuPos == "position-fixed top-0 start-0 end-0"
