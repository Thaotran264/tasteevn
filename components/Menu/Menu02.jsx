...
const Menu02 = ({ isDefault, menuPos }) => {
    ...
    <>
      {!isDefault && (
        <div className="container py-2 " id="menu">
          {/* Menu 2 */}
          {/* MObile menu */}
          <div className=" hideOnDesktop row position-relative">
            {/* Mobile menu */}
            <div
              className={` menuRecipe bg-white col-12 col-md-4 py-1 ${menuPos == "position-fixed top-0 start-0 end-0" ? menuPos + " gx-5 active" : ""
                }`}
              style={
                menuPos == "position-fixed top-0 start-0 end-0" ? { marginTop: 54, zIndex: 99 } : {}
              }
            >
              <ul
                ref={menuRef}
                className=" list-group d-flex flex-row bg-white gap-1 w-100"
                style={{ overflow: "scroll", padding: "10px 0" }}
              >
                <li className="list-group-item w-50" style={{ backgroundColor: "transparent" }}>
            ...
            {/*End Mobile menu */}
            <div
              className={`col-12 col-md-8 bg-white py-1 ${menuPos == "position-fixed top-0 start-0 end-0" ? "offset-md-4" : ""
                }`}
            >
          ...
          <div className="row hideOnMB ">
            {/* Mobile menu */}
            <div
              className={` bg-white ${menuPos == "position-fixed top-0 start-0 end-0"
                  ? "position-fixed container"
                  : "col-md-4"
                }`}
              style={
                menuPos == "position-fixed top-0 start-0 end-0" ? { top: 56, width: 1320 } : {}
              }
            >
              <ul
                ref={menuRef}
            ...
            {/*End Mobile menu */}
            <div
              className={`${menuPos == "position-fixed top-0 start-0 end-0" && "offset-md-4"
                } col-md-8 bg-white py-1`}
            >
              <h4 id="menuRC01" ref={titleRef}>
                Menu
              </h4>
              ...
              >
                <div className="card">
                  ...
                  <div className="card-body">
                    ...
                    <span className="text-danger d-inline-block mb-1">85.000 đ</span>
                    <br />
