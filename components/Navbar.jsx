...
const Navbar = () => {
  ...
  return (
    <div
      className="container-fluid mb-2 bg-white position-fixed top-0 start-0"
      style={{ zIndex: 99 }}
      id="nav"
    >
      <div className="container ">
        <div className="row py-2">
          <div className="col-3 col-md-2 col-lg-1 d-flex">
            <a className="navbar-brand text-light align-self-center " href="#">
              <img
                src="/image/logo.jpg"
                alt=""
                style={{ width: "100%", objectFit: "cover", height: "40%", display: "block" }}
              />
            </a>
          </div>
          ...
          <div className="col-6 col-md-3 col-lg-2 d-flex align-items-center justify-content-around cart-user">
            ...
            {!username && <LoginModal></LoginModal>}
          </div>
        </div>
      </div>
    </div>
